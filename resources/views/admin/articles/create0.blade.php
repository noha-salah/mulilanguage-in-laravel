...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <li class="nav-item">    <button class="Show nav-link ">ar</button>     </li>
  <li class="nav-item">    <button class="Hide nav-link ">en</button>   </li>
  ...
  {{ csrf_field() }}
      ...
      <div class="card-body d-none" id="spanish-form">
          ...
          <div class="form-group">
              <label for="ar_full_text">{{ trans('cruds.article.fields.full_text') }} (ar)</label>
